...
<body>
  ...
  <a-scene mindar-image="imageTargetSrc: {{ asset('aframe/examples/assets/prueba_lateral_derecho.mind') }}; filterMinCF:0.0001; filterBeta:0.0001;"
    ...
    <a-assets>
      <a-asset-item id="avatarModel" src="{{ asset('aframe/examples/image-tracking/nft/PROP_DGCS_B.gltf') }}"></a-asset-item>
    </a-assets>
  ...
  <body>
    ...
    <a-scene mindar-image="imageTargetSrc: {{ asset('aframe/examples/assets/prueba_lateral_derecho.mind') }}; filterMinCF:0.001; filterBeta:0.001;" color-space="sRGB" renderer="colorManagement: true, physicallyCorrectLights" vr-mode-ui="enabled: false" device-orientation-permission-ui="enabled: false" >
      <a-assets>
        ...
        <a-asset-item id="raccoonModel" src="{{ asset('aframe/examples/image-tracking/nft/PROP_DGCS_F.gltf') }}"></a-asset-item>
      </a-assets>
